...
public class AbWheelUtil {
     ...
     */
    public static void initWheelTimePicker(final TextView mText, final AbWheelView mWheelViewMD, final AbWheelView mWheelViewHH, final AbWheelView mWheelViewMM,
                                           Button okBtn, Button cancelBtn,
