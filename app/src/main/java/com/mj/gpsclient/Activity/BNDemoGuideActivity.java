...
public class BNDemoGuideActivity extends Activity {
	...
	private final String TAG = "BNDemoGuideActivity";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (intent != null) {
			...
			if (bundle != null) {
				mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(FollowingAllTimeActivity.ROUTE_PLAN_NODE);
			}
		}
		//显示自定义图标
		if (hd != null) {
	...
	protected void onDestroy() {
		...
		FollowingAllTimeActivity.activityList.remove(this);
