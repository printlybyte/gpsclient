...
//	public void isChanged(ArrayList<MKOLUpdateElement> localMapList) {
//		this.localMapList = localMapList;
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if(update!=null){
			if(update.status==1){
				...
				viewHolder.isdownload_tv.setTextColor(context.getResources().getColor(color.red));
				...
				viewHolder.isdownload_tv.setTextColor(context.getResources().getColor(color.black));
			}
